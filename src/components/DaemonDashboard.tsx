  ...
  return (
    ...
    >
      <div className="flex items-center gap-4">
        <span className="font-mono font-bold text-sm text-accent">DAEMON://REZINAS</span>
...
export function DaemonDashboard() {
  ...
  async function fetchDaemonData() {
    ...
    try {
      const toolsResponse = await fetch('https://mcp.daemon.rick.rezinas.com', {
        method: 'POST',
      ...
      const dataResponse = await fetch('https://mcp.daemon.rick.rezinas.com', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          jsonrpc: '2.0',
    ...
    <div className="max-w-6xl mx-auto px-6 space-y-4">
      ...
      >
        <div className="rounded-xl border border-border-subtle bg-bg-tertiary/50 backdrop-blur-sm p-6 max-w-md w-full text-center">
          ...
          <code className="font-mono text-base text-brand block mb-3">mcp.daemon.rick.rezinas.com</code>
